...
public class ProfileFragment extends Fragment implements Refreshable {
    ...
    private Button mProfileProjects;
    ...
    View.OnClickListener transferClick = v -> {
        Bundle args = new Bundle();
        args.putString(PROFILE_KEY, mUsername);

        getFragmentManager().beginTransaction()
                .replace(R.id.fragmentContainer, UserProjectsFragment.newInstance(args))
                .commit();
    };
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mProfileProjects = view.findViewById(R.id.btn_user_projects);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mProfileProjects.setOnClickListener(transferClick);
